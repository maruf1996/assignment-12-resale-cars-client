...
const Register = () => {
    ...
    return (
        ...
        <h1 className='text-center mb-5 fw-bold fs-1 text-danger'>Register</h1>
        ...
        <input className='form-control form-control-lg mb-3' defaultValue="" {...register("name", {required: "Name is required"})} />
        {errors.name && <p className='text-danger'>{errors.name?.message}</p>}
        <label className="form-label mt-3">Email</label>
        <input className='form-control form-control-lg mb-3' defaultValue="" {...register("email", {required: "Email Address is required"})} />
        ...
        <p className='create_para'>Already have an account ? <Link to="/login" className='text-decoration-none'>Sign In</Link></p>
       </div>
        </div>
    );
};
